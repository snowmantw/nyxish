define('Module', [], function() {
   ...
   *
   * The generator would have 'name', which is its own unique name, the
  ...
  Module.prototype.define = function(content) {
    ...
    method.name = this.generatorName();
   ...
   * the module transferring.
   */
  Module.prototype.transfer = function(generator, pred) {
    if (generator.moduleName !== this.name) {
  ...
  Module.prototype.stateName = function() {
    return this.name + '-state-' + Date.now();
  };

  Module.prototype.generatorName = function() {
    return this.name + '-generator-' + Date.now();
  };
